...
t.setText("");
    ...
    public void next(View view) {
        ...
        if (S.click == true ||S.someClick==true) {
            ...
            else {constraintLayout.setBackgroundColor(ContextCompat
                    .getColor(this, R.color.FireBrick));
            }
            t.setText(""+S.wordtoscreen);
            setWordinMas();
            if (steps==lengthINscore){ t.setText("GAME OVEr  "+S.win+"  OF  "+lengthINscore+"    Try again");
                S.click =false;
                S.someClick=false;
            }
        }
