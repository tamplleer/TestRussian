...
public class WordFragment implements CallBack {
    ...
    WordFragment(Context context, DataBaseWords dataBaseWords, androidx.fragment.app.FragmentManager fragmentManagerSupport) {
    ...
    void createFragment(String type) {
        ...
        while (dataBaseWords.isFinishDataBase()) {
            ...
            myFragment.setParams(dataBaseWords.readFromDataBaseAllWord(type), type, this, key);
    ...
    public void execute(String message, String word, String type, UUID id) {
       ...
       /*         myFragment = new Fragment_data_base();
                ...
                UUID key = UUID.randomUUID();
                fragmentMap.put(key, myFragment);
                myFragment.setParams(new Pair<String, Boolean>("bublИк", true), type, this, key);
                fragmentTransaction.add(R.id.container, myFragment);
                fragmentTransaction.commit();*/
            }
            break;
